...
export default function Page() {
  return <InfoPage
    ...
    sections={[
      ...
      { heading: "AFM registration", body: "Blockto B.V. is registered with the Netherlands Authority for the Financial Markets (AFM) as an information service provider. This registration does not constitute an AFM licence to provide investment services." },
    ]}
  />;
}
