...
import HalvingWidget from "@/components/features/HalvingWidget";
    ...
    <div className="relative z-[2] max-w-[860px] mx-auto px-4 md:px-8 pt-5 pb-24 space-y-6">
      ...
      <InfoPage
        ...
        sections={[
          ...
          { heading: "Halving history", body: ["• Block 0 (2009) — Reward: 50 BTC", "• Block 210,000 (Nov 2012) — Reward: 25 BTC", "• Block 420,000 (Jul 2016) — Reward: 12.5 BTC", "• Block 630,000 (May 2020) — Reward: 6.25 BTC", "• Block 840,000 (Apr 2024) — Reward: 3.125 BTC", "• Block 1,050,000 (~2028) — Reward: 1.5625 BTC"] },
          ...
          { heading: "Data source", body: "Live block height and hash rate data powered by Mempool.space. Countdown calculated from real-time block production rate." },
        ]}
      />
    </div>
  );
