...
export default function Page() {
  return <InfoPage
    ...
    subtitle="How Blockto B.V. collects, uses, and protects your personal data."
    lastUpdated="23 April 2026"
    sections={[
      { heading: "1. Who we are", body: "Blockto B.V., registered in the Netherlands (KvK: NL 89234567), Maliebaan 45, 3581 CD Utrecht. Data Protection contact: privacy@blockto.io" },
