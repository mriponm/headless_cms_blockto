...
export default function Page() {
  return <InfoPage
    ...
    sections={[
      ...
      { heading: "Registered entity", body: "Blockto B.V. is registered in the Netherlands (KvK: NL 89234567 · VAT: NL864523901B01) and operates as an information service provider registered with the AFM." },
    ]}
  />;
}
