...
export default function Page() {
  return <InfoPage
    ...
    sections={[
      ...
      { heading: "7. Limitation of liability", body: "To the maximum extent permitted by Dutch law, Blockto shall not be liable for financial losses arising from reliance on information published on this platform. You assume full responsibility for your investment decisions." },
