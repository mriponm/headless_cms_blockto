...
export default function Page() {
  return <InfoPage
    ...
    sections={[
      { heading: "Our commitment", body: "Blockto is fully committed to compliance with the General Data Protection Regulation (GDPR — EU 2016/679). As a Dutch company, GDPR compliance is both a legal obligation and a core value." },
      ...
      { heading: "Data Protection Officer", body: "Blockto has appointed a Data Protection contact. For DPO enquiries: dpo@blockto.io" },
